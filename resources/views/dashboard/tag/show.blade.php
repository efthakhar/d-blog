                    ...
                    <div class="card-body">
                      ...
                      <form class="col-md-7" method="post" action="{{route('tag.update',$tag->id)}}" >
                        ...
                        <div class="mb-3">
                          ...
                          <input disabled type="text" class="form-control" id="tag_name" 
                        ...
                        <div class="mb-3">
                          ...
                          <input disabled type="text" class="form-control" id="tag_slug" 
                        ...
                        <div class="mb-3">
                          ...
                          <textarea disabled name="tag_description" class="form-control" placeholder="tag about something......" >{{$tag->tag_description}}</textarea>
                        </div>
